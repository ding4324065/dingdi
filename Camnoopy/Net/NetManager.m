    ...
    [self requestHttp:currentServer actionPath:@"Users/LoginCheck.ashx" parameter:parameter
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  ...
                  if(reconnectCount<([servers count]-1)){
                      ...
                      loginResult.error_code = NET_RET_UNKNOWN_ERROR;//999
                      if (error) {
                          loginResult.error_code = (int)error.code;
                      }
                      callBack(loginResult);
                      [loginResult release];
                  }
    ...
    [self requestHttp:currentServer actionPath:@"Users/Logout.ashx" parameter:parameter
              success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                  ...
                  if(error_code==NET_RET_SESSION_ERROR){
                      ...
                      if(reconnectCount<([servers count]-1)){
                          ...
                          [self randomServer];
                          reconnectCount = 0;
                          NSString *unknownErrorString = [NSString stringWithFormat:@"%d",error_code];
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  if(reconnectCount<([servers count]-1)){
                      ...
                      NSString *unknownErrorString = [NSString stringWithFormat:@"%d",errorCode];
                      callBack(unknownErrorString);
                  }
...
-(void)getHelpUrlCallBack:(void (^)(id JSON))callBack{
    
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        //版本号（主版本号+子版本号）00.46.01.09
        NSArray *array = [[AppDelegate getAppVersion] componentsSeparatedByString:@"."];
        
        //设置URL路径
        NSString *urlStr = [NSString stringWithFormat:@"http://upg1.cloudlinks.cn/upg/android/%@/%@/help.asp",array[0],array[1]];
        ...
        if (error) {
            DLog(@"错误信息:%@",[error localizedDescription]);
            NSString *unknownErrorString = [NSString stringWithFormat:@"%ld",(long) error.code];
            callBack(unknownErrorString);
        }else{
    ...
    [self requestHttp:currentServer actionPath:@"Users/UpdateSafeSet.ashx" parameter:parameter
              success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                  ...
                  if(error_code==NET_RET_SESSION_ERROR){
                      ...
                      if(reconnectCount<([servers count]-1)){
                          ...
                          accountResult.error_code = error_code;
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  if(reconnectCount<([servers count]-1)){
                      ...
                      reconnectCount = 0;
                      AccountResult *accountResult = [[AccountResult alloc] init];
                      accountResult.error_code = error ? error.code : NET_RET_UNKNOWN_ERROR;
    ...
    [self requestHttp:currentServer actionPath:@"Users/UpdateSafeSet.ashx" parameter:parameter
              success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                  ...
                  if(error_code==NET_RET_SESSION_ERROR){
                      ...
                      if(reconnectCount<([servers count]-1)){
                          ...
                          callBack([NSString stringWithFormat:@"%ld",(long)error_code]);
                      }
                  }else{
                      callBack([result valueForKey:@"error_code"]);
                      [self resetServer];
                  }
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  ...
                  if(reconnectCount<([servers count]-1)){
                      ...
                      [self randomServer];
                      reconnectCount = 0;
                      callBack(error ? [NSString stringWithFormat:@"%ld",(long)error.code] : [NSString stringWithFormat:@"%ld",(long)NET_RET_UNKNOWN_ERROR]);
    ...
    [self requestHttp:currentServer actionPath:@"Users/ModifyPwd.ashx" parameter:parameter
              success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                  ...
                  if(error_code==NET_RET_SESSION_ERROR){
                      ...
                      if(reconnectCount<([servers count]-1)){
                          ...
                          modifyLoginPasswordResult.error_code = error_code;
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  if(reconnectCount<([servers count]-1)){
                      ...
                      reconnectCount = 0;
                      ModifyLoginPasswordResult *modifyLoginPasswordResult = [[ModifyLoginPasswordResult alloc] init];
                      modifyLoginPasswordResult.error_code = error ? error.code : NET_RET_UNKNOWN_ERROR;
                      callBack(modifyLoginPasswordResult);
    ...
    [self requestHttp:currentServer actionPath:@"Users/PhoneCheckCode.ashx" parameter:parameter
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  ...
                  if(reconnectCount<([servers count]-1)){
                      ...
                      NSString *unknownErrorString = [NSString stringWithFormat:@"%d", error ? error.code : NET_RET_UNKNOWN_ERROR];
    ...
    [self requestHttp:currentServer actionPath:@"Users/RegisterCheck.ashx" parameter:parameter
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  if(reconnectCount<([servers count]-1)){
                      ...
                      [self randomServer];
                      reconnectCount = 0;
                      callBack([NSString stringWithFormat:@"%ld",error?(long)error.code:(long)NET_RET_UNKNOWN_ERROR]);
    ...
    [self requestHttp:currentServer actionPath:@"MSG/IsAnyMsgEx.ashx" parameter:parameter
              success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                  ...
                  if(((NSString*)[result valueForKey:@"error_code"]).intValue==NET_RET_SESSION_ERROR){
                      ...
                      if(reconnectCount<([servers count]-1)){
                          ...
                          checkNewMessageResult.error_code = error_code;
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  if(reconnectCount<([servers count]-1)){
                      ...
                      reconnectCount = 0;
                      CheckNewMessageResult *checkNewMessageResult = [[CheckNewMessageResult alloc] init];
                      checkNewMessageResult.error_code = error ? error.code : NET_RET_UNKNOWN_ERROR;
                      callBack(checkNewMessageResult);
                      [checkNewMessageResult release];
    ...
    [self requestHttp:currentServer actionPath:@"MSG/IsAnyMsgEx.ashx" parameter:parameter
              success:^(NSURLRequest *request, NSHTTPURLResponse *response, id JSON) {
                  ...
                  if(((NSString*)[result valueForKey:@"error_code"]).intValue==NET_RET_SESSION_ERROR){
                      ...
                      if(reconnectCount<([servers count]-1)){
                          ...
                          checkAlarmMessageResult.error_code = error_code;
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  if(reconnectCount<([servers count]-1)){
                      ...
                      reconnectCount = 0;
                      CheckAlarmMessageResult *checkAlarmMessageResult = [[CheckAlarmMessageResult alloc] init];
                      checkAlarmMessageResult.error_code = error ? error.code : NET_RET_UNKNOWN_ERROR;
                      callBack(checkAlarmMessageResult);
                      [checkAlarmMessageResult release];
...
- (void) getAlarmRecordWithUsername:(NSString *)username sessionId:(NSString *)sessionId option:(NSString*)option msgIndex:(NSString *)msgIndex senderList:(NSString *)senderList checkLevelType:(NSString *)checkLevelType vKey:(NSString *)vKey callBack:(void (^)(id JSON))callBack{
    ...
    //MD5 ONCE
    NSString *md5Pwd = [vKey getMd5_32Bit_String];
    //encrypt
    BYTE pbBuf[16];
    for (int i = 0; i < 32; i += 2) {
        NSString *str = [md5Pwd substringWithRange:NSMakeRange(i, 2)];
        pbBuf[i/2] = [str charToInt];
    }
    [Utils vEncVal:pbBuf size:16];
    //MD5 TWICE
    NSMutableString *newPwd = [NSMutableString stringWithCapacity:0];
    for (int i=0; i<16; i++) {
        NSString *str = [NSString stringWithFormat:@"%02x",pbBuf[i]];
        [newPwd appendString:str];
    }
    NSString *newMd5Pwd = [newPwd getMd5_32Bit_String];
    [parameter setObject:newMd5Pwd forKey:@"VKey"];
    ...
    [self requestHttp:currentServer actionPath:@"Alarm/AlarmRecordEx.ashx" parameter:parameter
              ...
              failure:^(NSURLRequest *request, NSHTTPURLResponse *response, NSError *error, id JSON) {
                  if(reconnectCount<([servers count]-1)){
                      ...
                      GetAlarmRecordResult *alarmresult = [[GetAlarmRecordResult alloc]init];
                      alarmresult.error_code   = error ? error.code : NET_RET_UNKNOWN_ERROR;
                      [self randomServer];
                      reconnectCount = 0;
                      callBack(alarmresult);
                      [alarmresult release];
