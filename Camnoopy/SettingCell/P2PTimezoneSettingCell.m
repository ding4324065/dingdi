...
//    if(!self.customView){
//        
//        TimezoneView *timezoneView = [[TimezoneView alloc] initWithFrame:CGRectMake(0,5, cellWidth, cellHeight1-5*2)];
...
//        [self.customView setFrame:CGRectMake(0,5, cellWidth, cellHeight1-5*2)];
//        
//        [self.contentView addSubview:self.customView];
//        
//        [self.customView setHidden:self.isCustomViewHidden];
