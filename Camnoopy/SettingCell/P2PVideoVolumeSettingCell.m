...
-(void)layoutSubviews{
    ...
    if(!self.customView){
        UIView *customView = [[UIView alloc] initWithFrame:CGRectMake(self.leftLabelView.frame.origin.x+self.leftLabelView.frame.size.width+5,5, cellWidth1-(self.leftLabelView.frame.origin.x+self.leftLabelView.frame.size.width+5+50), cellHeight1-5*2)];
        
        UISlider *slider = [[UISlider alloc] initWithFrame:CGRectMake(25, 0, customView.frame.size.width, customView.frame.size.height)];
        ...
        self.customView.frame = CGRectMake(self.leftLabelView.frame.origin.x+self.leftLabelView.frame.size.width+5,5, cellWidth1-(self.leftLabelView.frame.origin.x+self.leftLabelView.frame.size.width+5+50), cellHeight1-5*2);
        self.slider.frame = CGRectMake(25, 0, self.customView.frame.size.width, self.customView.frame.size.height);
        [self.contentView addSubview:self.customView];
        [self.customView setHidden:self.isCustomViewHidden];
    }
