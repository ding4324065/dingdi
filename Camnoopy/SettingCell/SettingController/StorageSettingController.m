...
//    [sep_view release];
    ...
    [tableView setBackgroundColor:XWhite];
    tableView.backgroundView = nil;
    [tableView setSeparatorStyle:UITableViewCellSeparatorStyleSingleLine];
    [tableView setBackgroundView:[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"background2"]]];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(cell==nil){
        ...
        //cell.textLabel.frame = CGRectMake(0, 0, 320, cell.frame.size.height);
        //cell.leftLabelView.frame = CGRectMake(0, 0, 320, cell.frame.size.height);
    }
