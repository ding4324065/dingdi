...
-(void)initComponentOfSystemDefaultEmail:(CGFloat)width height:(CGFloat)height{
    ...
    UIImage *unbindButtonImage = [UIImage imageNamed:@"delete_device_btn.png"];
    UIImage *unbindButtonImage_p = [UIImage imageNamed:@"delete_device_btn.png"];
    ...
    [unbindButton setTitle:NSLocalizedString(@"UNbind", nil) forState:UIControlStateNormal];
...
-(void)initComponentDefault:(CGFloat)width height:(CGFloat)height{
    ...
    dropDownBtn.tag = 21;
    [dropDownBtn setImage:[UIImage imageNamed:@"dropdown3.png"] forState:UIControlStateNormal];
...
-(void)initComponentManual:(CGFloat)width height:(CGFloat)height{
    ...
    [m_dropDownBtn setImage:[UIImage imageNamed:@"dropdown3.png"] forState:UIControlStateNormal];
    ...
    UIImage *m_unbindButtonImage = [UIImage imageNamed:@"delete_device_btn.png"];
    UIImage *m_unbindButtonImage_p = [UIImage imageNamed:@"delete_device_btn.png"];
    ...
    [m_unbindButton setTitle:NSLocalizedString(@"UNbind", nil) forState:UIControlStateNormal];
...
- (void)changeOpenStatus:(UIButton *)button {//email新调整
    if (isOpened) {
        [UIView animateWithDuration:0.3 animations:^{
            ...
            UIImage *closeImage=[UIImage imageNamed:@"dropdown3.png"];
            if (button.tag == 20) {
                [self.m_dropDownBtn setImage:closeImage forState:UIControlStateNormal];
            }else{
        ...
        [UIView animateWithDuration:0.3 animations:^{
            UIImage *openImage=[UIImage imageNamed:@"dropup3.png"];
            if (button.tag == 20) {
...
-(void)bindedDefaultSystemEmail{
    ...
    //邮箱长度应为5~31
    if(reciEmail.length<5||reciEmail.length>100){
