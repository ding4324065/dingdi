    ...
    @synchronized(self)
    {
        ...
        if ([_renderer prepareRender])
        {
               ...
               ) ///shengming
            {
                ...
                //            NSLog(@"%f--%f",flPlayVideoWidth,flPlayVideoHeight);
                [self updateVertices];
            ...
            BOOL bValid = validateProgram(_program);
            //        NSLog(@"bValid = %d", bValid);
#if 0
        ...
        //    NSLog(@"presentRenderbuffer start");
        [_context presentRenderbuffer:GL_RENDERBUFFER];
        //    NSLog(@"presentRenderbuffer end");
