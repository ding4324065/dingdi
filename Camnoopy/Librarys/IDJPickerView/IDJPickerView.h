...
@property (nonatomic, retain) UIImageView *selectedCenterView;
@property (nonatomic, retain) UIImageView *pickerLeftView;
@property (nonatomic, strong) UILabel *line1;
@property (nonatomic, strong) UILabel *line2;
@property (assign) BOOL lin1Ishidden;
@property (assign) BOOL lin2Ishidden;
@property (assign) BOOL leftViewIshidden;
