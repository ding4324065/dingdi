...
#pragma mark - 刷新动画放置 - 使其居中
    self.frame = CGRectMake(scrollView.bounds.size.width*0.08, -60, scrollView.bounds.size.width, 60);
...
- (void)setState:(SVPullToRefreshState)newState {
    ...
    switch (newState) {
        case SVPullToRefreshStateHidden:
            titleLabel.text = NSLocalizedString(@"pull_to_refresh",);
        ...
        case SVPullToRefreshStateTriggered:
            titleLabel.text = NSLocalizedString(@"release_refresh",);
