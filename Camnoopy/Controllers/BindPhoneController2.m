...
//    [topBar.rightButton addTarget:self action:@selector(onNextPress) forControlEvents:UIControlEventTouchUpInside];
    ...
    /*下一步按钮*/
    UIButton *nextBtn = [[UIButton alloc]initWithFrame:CGRectMake(5, height - 55, width - 10, 38)];
    [nextBtn setBackgroundImage:[UIImage imageNamed:@"new_button.png"] forState:UIControlStateNormal];
