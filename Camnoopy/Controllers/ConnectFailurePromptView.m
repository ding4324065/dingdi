...
#define SET_WIFI_CONTENT_BOTTOM_BUTTON_WIDTH 150
#define SET_WIFI_CONTENT_BOTTOM_BUTTON_HEIGHT 32
#define WAITING_CONTENT_VIEW_WIDTH 248
#define WAITING_CONTENT_VIEW_HEIGHT 310
...
//    添加设备失败，请重新添加
    titleLable.text = NSLocalizedString(@"set_wifi_failed_title", nil);
    ...
    UILabel *waitingContentLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, waitingContentTop.frame.origin.y+waitingContentTop.frame.size.height - 20, waitingContent.frame.size.width-10*2, 90)];
    ...
    waitingContentLabel.text = NSLocalizedString(@"set_wifi_failed_prompt", nil);
    ...
    bottomButton1.frame = CGRectMake((waitingContent.frame.size.width-SET_WIFI_CONTENT_BOTTOM_BUTTON_WIDTH)/2, waitingContent.frame.size.height-42, SET_WIFI_CONTENT_BOTTOM_BUTTON_WIDTH, SET_WIFI_CONTENT_BOTTOM_BUTTON_HEIGHT);//原来的
