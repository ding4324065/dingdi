...
//    }智能连接失败后出现
//    self.SetWifiToAddDeviceByQR = @"SetWifiToAddDeviceByQR";
//    NSLog(@"****%@",self.SetWifiToAddDeviceByQR);
//    if ([self.SetWifiToAddDeviceByQR isEqualToString:@"SetWifiToAddDeviceByQR"]) {
...
#pragma mark -  摄像头即将连接的Wi-Fi
    _textLable.text = NSLocalizedString(@"adddevice_tip", nil);
...
#pragma mark -   将Wi-Fi的名字和密码传到下个界面
        ...
        qrcodeNextController.isButtonSend = self.saveButton.enabled;
